	...
	tests := []struct {
		...
		{name: "One book with genre",
			...
			wantedStatements: map[string]string{
				...
				"SELECT": "SELECT * FROM generos_dos_livros WHERE livro = \"1\"",
				"TEST":   "",
			},
		},
		{name: "Empty genre",
			...
			wantedStatements: map[string]string{
				...
				"SELECT": "SELECT * FROM generos_dos_livros WHERE livro = \"2\"",
				"TEST":   "",
			},
		},
		{name: "Empty genre ID",
			...
			wantedStatements: map[string]string{
				...
				"SELECT": "SELECT * FROM generos_dos_livros WHERE livro = \"3\"",
				"TEST":   "",
			},
		},
		{name: "Empty book ID",
